        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Extended UI /</span> Miscellaneous</h4>
                      ...
                      <div class="row">
                        <div class="col-md-6 col-12 mb-md-0 mb-4">
                          ...
                          <div class="btn-group mb-3">
                            <button type="button" id="document-Pause" class="btn btn-primary btn-sm">Pause</button>
                            <button type="button" id="document-Resume" class="btn btn-primary btn-sm">Resume</button>
                            <button type="button" id="document-Elapsed" class="btn btn-primary btn-sm">Elapsed</button>
                            <button type="button" id="document-Init" class="btn btn-primary btn-sm">Init</button>
                            <button type="button" id="document-Destroy" class="btn btn-primary btn-sm">Destroy</button>
                          </div>
                        ...
                        <div class="col-md-6 col-12">
                          ...
                          <div class="btn-group mb-3">
                            <button type="button" id="element-Reset" class="btn btn-primary btn-sm">Reset</button>
                            ...
                            <button type="button" id="element-State" class="btn btn-primary btn-sm">State</button>
                          </div>
