        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">UI Elements /</span> Cards Actions</h4>
                  ...
                  <div class="card card-action mb-4">
                    ...
                    <div class="collapse show">
                      <div class="card-body">
                        ...
                        <p class="card-text">
                          Click on <i class="tf-icons ti ti-chevron-right scaleX-n1-rtl ti-sm"></i> to see card collapse
                          in action.
                        </p>
                      </div>
                    </div>
                ...
                <div class="col-md">
                  <div class="card card-action mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text">
                        Click on <i class="tf-icons ti ti-rotate-clockwise-2 scaleX-n1-rtl ti-sm"></i> icon to see
                ...
                <div class="col-md">
                  <div class="card card-action mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text">
                        Click on <i class="tf-icons ti ti-arrows-maximize ti-sm"></i> icon to see expand card in action.
                      </p>
                    </div>
                  </div>
                </div>
